...
<!-- ! there is a jump in css because of original style and spin transition. So like opacity (getComputedStyle) we need to do the same for transform -->
<!-- js animation => transition:fade style="opacity:0.5; transform: rotate(90deg)" -->
{#if showList}
